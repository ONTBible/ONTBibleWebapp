...
# cargo-leptos écrit le manifeste des empreintes à côté du binaire serveur,
# dans `target/release/` — que `--frontend-only` ne crée pas, puisqu'il ne
# construit pas ce binaire.
